...
<div class="promo">
    ...
    <div class="promo-desc">
        ...
        <h3><span>Asian Logistic Solutions</span> Updates Code of Business Ethics and Conduct</h3>

        <span>Asian Logistic Solutions logistics is leading name in integrated Global Logistics Services with efficient time bound services.</span>
...
<div class="col_one_third">
    <div class="product-feature product-feature3"><span class="icon-anchor" style="color: #1CC6B0"></span>
        ...
        <p>When you have Ocean Freight experts matching incessant sailings and adaptable administration to
            your particular business goals, you have one name Asian Logistic Solutions</p></div>
</div>
...
<div class="col_one_third">
    <div class="product-feature product-feature3"><span class="icon-plane" style="color: #C75ACF"></span>
        ...
        <p>When you have an experienced team of Air Freight specialists delivering on your daily priorities for time,
            space, frequency and cost, you have one name Asian Logistic Solutions.</p></div>
</div>
...
<div class="col_one_third col_last">
    <div class="product-feature product-feature3"><span class="icon-truck" style="color: #804040"></span>
        ...
        <p>When you have a committed logistics partner planning and implementing a supply chain solution tailored to
            your specific needs, you have one name Asian Logistic Solutions.</p></div>
</div>
...
<div class="tab_widget side-tabs clearfix bottommargin" id="tabwidget-1">
    ...
    <div class="tab_container">
        ...
        <div id="tab-tab3" class="tab_content clearfix">
            ...
            <p>The proprietary Asian Logistic Solutions platform provides you with a common space to connect all parties along
        ...
        <div id="tab-tab4" class="tab_content clearfix">
            ...
            <p>When you need end-to-end support from your logistics partner, Asian Logistic Solutions can deliver the complete service.</p>
            ...
            <p>
                ...
                Asian Logistic Solutions has developed the Smart End to End concept to reduce both risk and cost. It makes your supply
        ...
        <div id="tab-tab5" class="tab_content clearfix">
            ...
            <blockquote class="topmargin"><p>At Asian Logistic Solutions our experienced supply chain engineers use the most up-to-date
